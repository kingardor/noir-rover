...
local_resource(
    'bridge',
    serve_cmd='set -a; [ -f .env ] && . .env; set +a; ROS_MASTER_URI=http://10.42.0.1:11311 ROS_IP=10.42.0.181 REDIS_URL=redis://localhost:6380 OLLAMA_URL=http://localhost:11434 AGENT_MODEL=nvidia/nemotron-3-nano-30b-a3b:free bash scripts/start_bridge.sh',
